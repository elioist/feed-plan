...
export function SearchBar({
  ...
  return (
    <Card size="small" className="art-search-bar">
        ...
        <Row gutter={12}>
          ...
          <Col xs={24} sm={24} md={actionSpan} lg={actionSpan}>
            <div className="art-search-bar-actions">
              ...
              {shouldShowExpand && (
                <div className="filter-toggle" onClick={toggleExpand}>
                  <span>{expanded ? '收起' : '展开'}</span>
                  <div className="icon-wrapper">{expanded ? <UpOutlined /> : <DownOutlined />}</div>
                </div>
              )}
            </div>
          </Col>
