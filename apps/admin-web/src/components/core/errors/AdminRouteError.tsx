...
export function AdminRouteError({ error, reset }: AdminRouteErrorProps) {
    ...
    return (
      <main className="admin-access-page">
        <section className="admin-access-panel" aria-labelledby="admin-access-title">
          <div className="admin-access-orbit" aria-hidden="true">
            <span />
            <span />
            <span />
          </div>
          ...
          <div className="admin-access-copy">
            ...
            <Result
              ...
              title={
                <h1 id="admin-access-title" className="admin-access-title">
                  访问受限
                </h1>
              }
              subTitle={<span className="admin-access-subtitle">{description}</span>}
              extra={
  ...
  return (
    <main className="admin-error-page">
      <section className="admin-error-panel" aria-labelledby="admin-route-error-title">
        <div className="admin-error-rail" aria-hidden="true">
          <span />
          <span />
          <span />
        </div>
        ...
        <div className="admin-error-copy">
          <div className="admin-error-kicker">
          ...
          <Result
            ...
            title={
              <h1 id="admin-route-error-title" className="admin-error-title">
                页面暂时不可用
              </h1>
            }
            subTitle={<span className="admin-error-subtitle">{description}</span>}
            extra={
              <Space wrap size="middle">
