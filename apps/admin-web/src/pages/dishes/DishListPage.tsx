...
import { Button, Drawer, Form, Image, Input, Select, Space, Switch, Table, Tag, App as AntdApp } from 'antd';
      ...
      <Table
        ...
        columns={[
          ...
          },
          {
            title: '状态',
            width: 120,
            render: (_, dish) => (dish.isActive ? <Tag color="green">启用</Tag> : <Tag>停用</Tag>),
          },
          {
            title: '操作',
            width: 220,
