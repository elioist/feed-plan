...
- [x] 13.1 扩展菜品数据模型、共享 schema 和迁移，支持标签与常见忌口项
- [x] 13.2 在菜谱表单和列表筛选中支持标签与忌口维护/查询
- [x] 13.3 新增用户管理后端 API、共享 schema、admin 页面和权限校验
- [x] 13.4 新增角色管理页面，展示 chef/diner 能力边界并支持必要的角色维护
- [x] 13.5 新增系统设置页面，承载主题切换和后续后台配置项
